...
def greedy_selection(doc_sent_list, abstract_sent_list, summary_size):
    def _rouge_clean(s):
        # return re.sub(r'[^a-zA-Z0-9 ]', '', s) # this will remove all chinese char
        return s
...
def format_to_lines_helper(input_path,golden_summ_path,output_path,task,file_list):
    ...
    for item in file_list:
        file_path = '{}/text_seg_Tree{}.txt'.format(input_path,item)
        summ_path = '{}/summary.A.Tree{}.txt'.format(golden_summ_path,item) # summary 也要有对应的分词，否则生成不了对应的label
        ...
        # print('----------------------article')
        # print(article_sentences_split)
        # print('----------------------abs')
        # print(abstract_sentences_split)
        sent_labels = greedy_selection(article_sentences_split, abstract_sentences_split, 10)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', type=str, default='/mnt/data/ztl/MTGNN-SUM/data_weibo/posts', help='The dataset directory.')
    parser.add_argument('--golden_summ_path', type=str, default='/mnt/data/ztl/MTGNN-SUM/data_weibo/summary', help='The golden summary directory.')
    parser.add_argument('--ouput_path', type=str, default='/mnt/data/ztl/MTGNN-SUM/data_weibo/exp_data', help='The dataset directory.')
